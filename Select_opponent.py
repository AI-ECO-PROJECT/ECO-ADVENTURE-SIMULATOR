...
def main_menu():
    ...
    while running:
        ...
        draw_text('Select Difficulty Level', font80, (0, 0, 0), screen, screen_width/2 -380, 20)
        draw_text('Medium', font45, (0, 0, 0), screen, screen_width/2 -300, 225)
        draw_text('Hard', font45, (0, 0, 0), screen, screen_width/2  +120, 220)
...
def level1():
    import jungle_multiplayer_hard
    jungle_multiplayer_hard.MP_game()


def level2():
    import jungle_multiplayer_medium
    jungle_multiplayer_medium.MP_game()
